...
class VW_Kids_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_kids_font_awesome_icon_array = vw_kids_font_awesome_icon_array();
                    foreach ($vw_kids_font_awesome_icon_array as $vw_kids_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_kids_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_kids_font_awesome_icon).'"></i>
                            <span class="vw-kids-social-class">'.esc_attr($vw_kids_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
if(!function_exists('vw_kids_font_awesome_icon_array')){
    function vw_kids_font_awesome_icon_array(){
