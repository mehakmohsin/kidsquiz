...
<?php if( get_theme_mod( 'vw_kids_discount_text') != '' || get_theme_mod( 'vw_kids_call') != '' || get_theme_mod( 'vw_kids_email') != '') { ?>
  ...
  <?php if( get_theme_mod('vw_kids_topbar_hide_show') != ''){ ?>
    <div id="topbar">
      <div class="container">
        <div class="row">
            ...
            <div class="row m-0">
              <div class="call col-lg-5 col-md-5">
                <?php if( get_theme_mod('vw_kids_call') != '' ){ ?>
                  <i class="<?php echo esc_attr(get_theme_mod('vw_kids_phone_number_icon','fas fa-phone')); ?>"></i><span><?php echo esc_html(get_theme_mod('vw_kids_call',''));?></span>
                <?php }?>            
              </div>
              <div class="email col-lg-7 col-md-7">            
                <?php if( get_theme_mod( 'vw_kids_email') != ''){ ?>
                  <i class="<?php echo esc_attr(get_theme_mod('vw_kids_email_icon','far fa-envelope')); ?>"></i><span><?php echo esc_html(get_theme_mod('vw_kids_email',''));?></span>
                <?php }?>
              </div>
            </div>
          </div>
