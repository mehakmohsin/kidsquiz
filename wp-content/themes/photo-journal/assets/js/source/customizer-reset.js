...
jQuery(function ($) {
    ...
    var sections = [
        [ '#customize-theme-controls', 'all', 'ct-reset', 'ct-reset-main', photoJournalCustomizerReset.confirm, photoJournalCustomizerReset.reset ] // Reset main.
    ];
    ...
    $.each( sections, function( key, value ) {
        ...
        $button.on('click', function (event) {
            ...
            var data = {
                wp_customize: 'on',
                action: 'photo_journal_customizer_reset',
