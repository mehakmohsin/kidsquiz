...
jQuery( document ).ready(function($) {
    ...
    $( document ).on( 'click', '.customize_multi_add_field', kiddiz_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', kiddiz_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', kiddiz_customize_multi_remove_field )
    ...
    function kiddiz_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            kiddiz_customize_multi_write( $control );
    }

    function kiddiz_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        kiddiz_customize_multi_write( $control );
    }

    function kiddiz_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function kiddiz_customize_multi_write( $element) {
