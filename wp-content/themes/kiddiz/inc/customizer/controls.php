 ...
 */
Class Kiddiz_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Kiddiz_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Kiddiz_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kiddiz-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class Kiddiz_Icon_Picker_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="kiddiz-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'kiddiz' ); ?>" class="kiddiz-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class Kiddiz_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
 ...
 * @see WP_Customize_Control
 */
Class Kiddiz_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @access public
 */
class Kiddiz_Customize_Section_Upsell extends WP_Customize_Section {
