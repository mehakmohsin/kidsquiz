...
*
* @package creativ_preschool
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #creativ-preschool-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #creativ-preschool-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-preschool-radio-img-selected') ;
        });
        $(this).addClass ('creativ-preschool-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #creativ-preschool-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #creativ-preschool-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-preschool-radio-img-selected') ;
        });
        $(this).addClass ('creativ-preschool-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #creativ-preschool-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #creativ-preschool-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-preschool-radio-img-selected') ;
        });
        $(this).addClass ('creativ-preschool-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #creativ-preschool-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #creativ-preschool-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-preschool-radio-img-selected') ;
        });
        $(this).addClass ('creativ-preschool-radio-img-selected') ;
    });   

    $('#customize-control-theme_options-layout_options_boxed #creativ-preschool-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_boxed #creativ-preschool-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-preschool-radio-img-selected') ;
        });
        $(this).addClass ('creativ-preschool-radio-img-selected') ;
    });                    
