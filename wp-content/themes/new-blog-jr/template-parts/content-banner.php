...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <div class="item">
			...
			<div class="caption">
				<div class="tag">
				<?php if (absint(get_theme_mod('new_blog_banner_slider_post_taxonomy_Category','1')) == 1) { ?>
				...
				<?php if (absint(get_theme_mod('new_blog_banner_slider_post_taxonomy_ReadMore','1')) == 1) { ?>
